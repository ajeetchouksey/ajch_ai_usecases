...
Output: content/usecases/cases/{id}.json
...
INTEL = ROOT / "content/usecases/_source-intel.json"
OUT_DIR = ROOT / "content/usecases/cases"
...
def main() -> None:
    ...
    print(f"\nDone — created {created} case files in content/usecases/cases/")
